 ...
 * @Last Modified time: 2019-03-26 09:17:10
 */
<!-- 全球路线 -->
<template>
    <div class="lines3d-globe" id="lines-3d-globe"></div>
</template>

<script>
import Lines from '@/assets/data/lines_3d/globe.json';
...
export default {
    ...
    methods: {
        getLines() {
            var myChart = this.$echarts.init(document.getElementById('lines-3d-globe'));
            ...
            myChart.setOption({
                ...
                globe: {
                    ...
                    // baseTexture: "../../../assets/img/echarts/globe.jpg",

                    // heightTexture: '../../../assets/img/echarts/globe.jpg',
