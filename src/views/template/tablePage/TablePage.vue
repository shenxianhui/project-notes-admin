...
<template>
  <div class="table-page">
        ...
        <div class="table-search-form">
          <el-form :model="form" :rules="rules" ref="form">
            ...
            <el-form-item label="年" prop="year">
              <el-date-picker v-model="form.year" type="year" format="yyyy" value-format="yyyy" placeholder="选择日期">
              </el-date-picker>
            </el-form-item>
    ...
    <!-- 弹出框 -->
    <el-dialog :title="dialog.title" :visible.sync="dialog.dialogVisible" @closed="closedDialog" top="0" width="35%">
      <div class="content">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        // 表单校验规则
        text: [{ min: 5, max: 20, message: '长度在 5 到 20 个字符' }],
        select: [],
